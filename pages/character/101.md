...
Community Given Tier: C (Weaker End)<br>B (Balanced characters that aren't really meta but also not really weak)<br>A (Strong characters, not strong enough to be the meta, but still powerful)<br>S (Meta characters, the best characters you can choose from, the top of this tier would probably be Strike Kendo)<br>Z (Meta-Warping, characters that warp everything around them and wreck havoc constantly, such as Prime Hawks and CD Spam Monoma with the right skills, beyond meta level, spot usually reserver to one or two characters that are always in everyone's mouths)
