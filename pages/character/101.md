...
## Combos
The different ways you can combine and chain various skills for higher damage. DMG displayed from all lowest level to all level 9.
...
This combo is extremely difficult to do in open areas, requiring you to aim the gamma in a way that changes the direction the opponent is flying towards in order to get the second gamma to hit. You also need gamma 9 to hit without a wall. fwefgwg.
<p align="center">
