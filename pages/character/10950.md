...
# <a style="color: lightblue !important;">DAMAGE AND HEALTH</a><br>
In this sub-guide you'll learn about My Hero Ultra Rumble's health types and how damage works!
...
### Healers
Characters with the ability to heal themselves and/or teammates (healing by reviving doesn't count). Of this list, Mr. Compress has the weakest and most limited healing, Overhaul has the greatest immediate healing, while Nejire has less healing power but is full of healing sources and gets more healing value than Overhaul fast.
