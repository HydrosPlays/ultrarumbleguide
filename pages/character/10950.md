...
@media (max-width: 768px) {
    .container-image-icon {
        ...
        float: left;                    /* old-school but brutally effective for stacking prevention */
        width: auto !important;
        margin: 0 !important;           /* nuke any inherited margins first */
    }
    ...
    .image-container {
        ...
        margin-bottom: 10px;
        padding: 7px;
        text-align: justify;            /* better distribution than center sometimes */
        font-size: 0;
        line-height: 0;
        overflow: hidden;               /* contains floats if we use them */
    }
    
    .image-container > * {
        display: inline-block !important;
        float: left !important;         /* double down */
        margin: 4px 8px 4px 0 !important;  /* right margin only, prevents last-item issues */
        vertical-align: top;
        width: auto !important;
    }
    
    .image-container::after {           /* clearfix hack */
        content: "";
        display: table;
        clear: both;
    }
...
<div class="image-container">
    ...
    <img class="container-image-icon" src="https://raw.githubusercontent.com/HydrosPlays/ultrarumbleguide/refs/heads/main/icons/momo_rapid.png" />
