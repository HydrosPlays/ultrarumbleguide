...
@media (max-width: 768px) {
    .container-image-icon {
        max-width: 48px;
        max-height: 48px;
        display: inline-block;     /* ← crucial if these are divs */
    ...
    .image-container {
        ...
        padding: 7px;
        text-align: center;
        font-size: 0;              /* removes inline spacing ghosts */
        line-height: 0;            /* sometimes helps too */
    }
    
    .image-container > * {
        display: inline-block !important;   /* override any block sneaking in */
        margin: 4px 6px;                    /* horizontal spacing more important */
        vertical-align: top;
        width: auto;
...
<div class="image-container">
    ...
    <img class="container-image-icon" src="https://raw.githubusercontent.com/HydrosPlays/ultrarumbleguide/refs/heads/main/icons/momo_assault.png" />
