...
In this sub-guide you'll learn about the character parameters that are shared across all characters (which is different from character-specific parameters like Denki's Lock-On range, that stuff will be covered in a different page)
