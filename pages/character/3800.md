...
When a projectile hits this barrier, Compress will quickly Compress it and reflect it back, dealing some extra damage the original projectile didn't have. This move is percentage based, meaning you can hold it up as much as you want, but the more hits it absorves the more percentage gets consumed until it's forced into reload. A helpful tip is that this move can be rolled to avoid the EndLag of deactivating it.
