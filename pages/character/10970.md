...
- Damage Recover Air Speed H Rate: 1
- Plus Ultra (Sphere Radius): 500 UU
- Special Action (Low Gravity Time): 15s

### Original Battle Style
- Class: Movespeed (Rapid)
- Max HP: 300 HP
- Max GP: 250 GP
- Alpha Skill (Sphere Radius): 64 UU
- Alpha Skill Charge (Sphere Radius): 64 UU
- Alpha Skill (Max Length): 5000 UU (All Levels)
- Beta Skill (Sphere Radius): 18 UU (Level 1-3), 25 UU (Level 4-8), 87.378426 UU (Level 9)
- Beta Skill Release (Sphere Radius): (Level 1-3), 46 UU (Level 4-8), 100 UU (Level 9)
- Beta Skill (Max Attack Time Seconds): 10 seconds (All Levels)
- Gamma Skill (Sphere Radius): 600 UU (Level 1-3), 650 UU (Level 4-8), 700 UU (Level 9)
- Gamma Skill (Max Float Time): 60 (Level 1-3), 120 (Level 4-8), 240 (Level 9)
- Gamma Skill (Spawn Range Radius): 560 UU (Level 1-3), 610 UU (Level 4-8), 660 UU (Level 9)
- Gamma Skill (Max Spawn Distance): 3000 UU (All Levels)

### Alternative Battle Style "Zero Satellites"
