...
- Max HP: 350 HP
- Max GP: 250 GP
- Alpha Skill (Sphere Radius H1): 32 UU
- Beta Skill Explosion (Capsule Radius H1): 400 UU (DISCLAIMER: For some reason all levels of the explosion are set to 400, so this might be a special parameter and not just a standard hitbox)
...
- Gamma Skill Explosion (Sphere Radius H1): 300 UU (DISCLAIMER: For some reason all levels of the explosion are set to 400, so this might be a special parameter and not just a standard hitbox)
