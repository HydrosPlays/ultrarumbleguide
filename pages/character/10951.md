...
Unknown as to where exactly this is used, but judging by the name, this should recover the player's health continuously. Might be related to Support Ability Cards, which have their dedicated condition further below, but this might be added on top.
...
Unknown whether this is actually for KOd players, or if it's for the DOWNd state, after all it says "Dying", not "Dead", and DOWN HP is called Dying Health internally.
