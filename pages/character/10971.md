...
This page is a simplified and easier to understand parameters page, which means several parameters were skipped or renamed to avoid cluttering. This page will also not update already existing entries unless the character received a balance update that might have changed their parameters or somebody joins our discord (https://discord.com/invite/z5JqqtfuDK) to ask for an update on a specific character's parameters. Otherwise, already existing entries here won't be updated due to how time consuming the task is. This page also does not contain values such as HP, damage, reload or ammo count since those values are already present in the normal character pages.<br>
<br>
You might also see a "hitbox" parameter in this page, it's unclear whether this is exactly the hitbox, but making the value large does seem to behave like a hitbox value. It seems consistent, but there's some weird cases like Strike Bakugo's beta or Rapid Bakugo's gamma, which show the same value at all levels even though their areas get larger with levels.<br>
<br>
In some skills you might see "Loop", this often refers to instances of a skill that have some animation you could loop to make it longer, for example, Technical Aizawa's beta and Assault Deku's beta both have looping, which is the time they're looping their movement animation until the attack is over, if you increased this value, deku would be stuck in his kick for longer, while aizawa would move forward while kicking the air for a while. Skills that mention "Slide" in a parameter often refer to the subtle position adjustment you can do with them, often while falling, like how you can adjust your position slightly while falling with Rapid Bakugo's gamma.

## Understanding the Units
For this page we will be using UU and UU/s as units for distance and speed respectively. UU (Unreal Unit) is the unit of measure this game uses, and here you can see some examples to grasp how much distance UUs are worth.
- Vertical Jumps for most characters: 300 UU of height.
- Fa Jin Jump Height: 1200 UU of height.
- World Height: Usually at 11,000 UU vertically.
- Map Radius: Usually between 28,000 and 32,000 UU.

## General Parameters
These are the parameters whose value is the same for all characters (though some conditions might alter them):

- Gravity: Set to a default value of -1480 UU/s
- Max Fall Speed: Set to a default value of -4000 UU/s
- Slide Adjust Speed For Fall: Set to a default value of 500 UU/s, this one defines the speed of the character when they're adjusting their position mid air, such as when you jump off a building and try to adjust your position to fall on a specific object. It seems to also be the stat that allows characters like Mirio to get very good value of the tuning "Acceleration".
- Dodge Invincible Span: Set to 0.3s by default. The amount of invincibility the character gets while dodging.
- Crouch Move Rate: 0.6
- Aiming Move Rate: 0.6
- Plus Ultra Shockwave Area: Set to 500 UU, defines how big is the area of the PU shockwave.
...
- Run (Final Speed): 600 UU/s
- Run (Speed Transition Time): 0.4s
- Dash (Initial Speed): 800 UU/s
- Dash (Final Speed): 1000 UU/s
- Dash (Speed Transition Time): 4s
- Vertical Jump Height: 300 UU
- Forward Jump Height 150 UU
- Forward Jump (Initial Speed): 800 UU/s
- Forward Jump (Final Speed): 700 UU/s
- Forward Jump (Speed Transition Time): 1s
- Wall Jump Height: 250 UU
- Wall Jump (Initial Speed): 600 UU/s
- Wall Jump (Final Speed): 500 UU/s
- Wall Jump (Speed Transition Time): 1s
- Climb (Initial Speed): 50 UU/s
- Climb (Final Speed): 700 UU/s
- Climb (Speed Transition Time): 0.4s
- Dodge (Initial Speed): 900 UU/s
- Dodge (Final Speed): 1000 UU/s

### Original Battle Style

- Alpha Skill (Hitbox): 64 UU
- Alpha Skill Charged Shot (Hitbox): 64 UU
- Beta Skill (Hitbox): 100 UU
...
- Beta Skill (Has Superarmor): Yes
- Gamma Skill (Hitbox): 32 UU

### Alternative Battle Style "Full Bullet"

- Alpha Skill (Hitbox): 64 UU
- Alpha Skill (Level Hitbox): 100 UU (Level 1-3), 120 UU (Level 4-9)
- Alpha Skill Aiming (Hitbox): 64 UU
- Beta Skill (Hitbox): 200 UU
- Beta Skill Shockwave (Hitbox): 700 UU
- Beta Skill (Move Time Limit): 0.25 (All Levels)
- Beta Skill (Fall Time): 6 seconds (All Levels)
- Beta Skill (Fall Initial Speed): -3000 UU/s (All Levels)
- Beta Skill (Fall Final Speed): -5000 UU/s (All Levels)
- Beta Skill (Fall Speed Transition Time): 2 seconds (All Levels)
- Beta Skill (Slide Speed): 350 UU/s (All Levels)
- Beta Skill (Low Height Threshold): 1500 UU (All Levels)
- Beta Skill (Middle Height Threshold): 1500 UU (All Levels)
