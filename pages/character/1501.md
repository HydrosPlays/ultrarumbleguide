...
Gamma is an ability split in two parts: The initial dash and the final shockwave. The Decay from gamma functions exactly the same as beta's, both the dash and the shockwave give the effect. The dash has negligible downpower, making it actually disgusting (in a good way) for his own combos, as well as being a great extender for team combos. The hitstop effect of gamma does also make it easier to line up combos for both your teammates and your own.
<p align="center">
