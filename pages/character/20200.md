...
GIF OF DEKU DASHING TWICE.

GIF OF DEKU DASHING AT NEJIRE AFTER GAMMA (NO GP), HITTING HER TO THE GROUND, THEN FOLLOWING AND DOING GROUND MELEE STRING

Values: 0 down power, 0 damage. 0 combo value. It takes 5% off of your ammo every dash.
...
This move is certainly something. To use it, hold down Gamma. A tracking reticle similar to Tech Denki’s will appear on any opponents within your range, followed by a massive dash towards the opponent and a slam to the ground. This move takes 20% of Deku’s ammo gauge to perform. Make sure you don’t put yourself on Gamma cooldown by using it too much or you’ll slow way down.
...
GIF OF LOCKING ONTO ENEMY AFTER HITTING THEM WITH GROUNDED ALPHA

Overdrive

Deku will rapidly approach the enemy you locked onto and deliver a swift punch downwards. This move hits like a truck and only has 300 down power, so you’re allowed to hit additional moves after it.
...
GIF OF THIS MOVE LITERALLY NOT WORKING

Its best use is on opponents that are high in the air. The opponent isn’t actionable and cannot tech until after they ground bounce. If you look down and fire two aerial Alphas at your opponent, you’ll be hitting for around 315 damage.

GIF OF GAMMA ON HIGH-UP OPPONENT INTO TWO ALPHAS

Typically you should not use this move on players that are on the ground. If they dodge it, you are incredibly minus and will most likely be heavily punished for it. However, this game has slightly spotty netcode, and the window for when the hit actually registers on the opponent is tied to when Deku changes direction, not when he actually hits the opponent with his fist. This will frequently allow you to get away with it anyways. If you do land a Gamma on a grounded opponent, you are able to hit grounded melee attacks afterwards if they do not tech fast enough.

GIF OF OVERDRIVE SMASH INTO GROUND MELEE
...
2. Evade out of his range. The range for this move’s activation is actually not that far, and you can typically get outside of his range just by dodging away. If you evade his range in time, you’ll see him do a normal Gamma dash forwards. However, if he manages to start his dash before you leave the range, he’ll chase you to the ends of the earth no matter how fast you are.

GIF OF DEKU CHASING YOU TO THE ENDS OF THE EARTH. MOST LIKELY KUROGIRI
...
GIF OF THE ROLL TIMING

Values: 300 down power, 155 damage, 0.52 combo value
