...
- When above enemies, aim Beta a decent distance to the side of enemies. There is currently a bug that causes Beta to miss when placed directly on top of enemies.
...
Tokoyami's Gamma commands Dark Shadow to protect Tokoyami with a small, weak shield with a large amount of utility. When used, Dark Shadow blocks in the direction that Tokoyami's crosshair is facing. While the shield is out, Tokoyami can perform specific actions while Dark Shadow is protecting him, such as reviving a teammate, opening a chest, or healing.<br>
If Tokoyami is downed, he can use Dark Shadow to provide protection for him. This can effectively stall an attempt to finish off Tokoyami, but keep in mind you cannot use Gamma while attacked and that Gamma is brittle.
                ...
                <div class="shield-table">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="color: purple !important;">
                                    <span style="display: inline-flex; align-items: center; gap: 4px;">
                                        <a style="flex-shrink: 0" href="https://ultrarumble.com/character/108">
                                ...
                                <td>🟡 Uncharged<br>🟡 Charged</td>
                                <td>🟡</td>
                                <td>✅ Dash<br>🟡 Follow-up</td>
                                <td>➖</td>
                                <td>✅ Melee 1<br>🟡 Melee 2<br>✅ Melee 3e</td>
                            </tr>
                            <tr>
                                <td style="color: lime !important;">
                                    <span style="display: inline-flex; align-items: center; gap: 4px;">
...
Toga's base form is very easy to lockdown as Tokoyami. As long as Tokoyami denies Toga his blood, then there should be no major issues.
...
- Try to close the distance against Toga to deter her from using Alpha.
  <br>
...
## Twice (Sad Man's Parade) <img src="https://ultrarumble.com/assets/Character/Ch037/GUI/FaceIcon/T_ui_Ch037_profile.png" width="70"/>

Difficulty Score: ➖ Need more Data ➖<br>
Placeholder

Tips vs. Twice (Sad Man's Parade):
...
### August 21st 2026 Update

Updated Toga Match-up
Added S18 character drafts
