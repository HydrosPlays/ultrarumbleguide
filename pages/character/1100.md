...
Beta can be used at entrances to prevent escapes outside should an enemy be far away enough from the entrance, but keep in mind that Beta is susceptible to line of sight checks.
...
<h4>Wake-ups versus flyers</h4>
If there is terrain nearby and there's an enemy that likes to use their movement ability right after wake-up, you can place Beta slightly above where they wake-up. 
Beta has a decent sized vertical hitbox which can catch their ground and air options.
...
If the enemy you're facing is very aggressive, then you can place Beta on yourself to prevent retaliation.
...
It's best used when you want a large reward for hitting people on wake-up.
