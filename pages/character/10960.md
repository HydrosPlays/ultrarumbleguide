...
## USJ (Ver.03)
USJ, also known as Stage 1, is Ultra Rumble's very first map, available since the game's release (though the Ver.02 came in Season 11). The stage is composed of 7 areas: Plaza, Typhoon Zone, Aquatic Zone, Fire Zone, Mountain Zone, Landslide Zone and Collapse Zone.
